...
import com.example.work10.bean.UserInfo;
import com.example.work10.database.UserDBHelper;
import com.example.work10.util.DateUtil;
import com.example.work10.util.ViewUtil;
...
public class MainMenu extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener , CompoundButton.OnCheckedChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "VIP用户","商家"};
