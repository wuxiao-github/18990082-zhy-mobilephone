...
import com.example.work05.bean.UserInfo;
import com.example.work05.database.UserDBHelper;
import com.example.work05.util.DateUtil;
import com.example.work05.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener , CompoundButton.OnCheckedChangeListener{
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990082 章涵阳"};
